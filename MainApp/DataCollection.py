...
class dataCollection:
    ...
    def collect(self):
        ...
        if(self.genre == ""):
            self.genre = input("Enter the genre you want to collect data for: ")
        #Commented out "single mode" functionality below until we find a real use for it
        #mode = input("Enter 'all' to process all files in the directory or 'single' for a specific file: ")

        def get_tracks_by_genre(genre, mode="all", limit=500):
        ...
        tracks = get_tracks_by_genre(self.genre)
